...
export const stagePresets: Record<(typeof stageOrder)[number], StagePreset> = {
  pre_seed: {
    ...
    upRoundProbability: 0.52,
    flatRoundProbability: 0.22,
    downRoundProbability: 0.26,
    stepUpRanges: {
      up: [1.8, 3.4],
      flat: [0.95, 1.2],
      down: [0.55, 0.95],
...
const stressScenario: ScenarioConfig = {
  ...
  preferred: {
    participationMode: "non_participating",
    liquidationMultiple: 1,
    antiDilutionMode: "broad_weighted_average",
  },
  operating: {
